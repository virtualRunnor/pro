...
const updateUserInfoHandler = async () => {
  ...
  await userLoginAndRegisterService(api.updateUserInfo, params)
...
const showEidiUserInfoDialog = (userInfo) => {
...
defineExpose({ showEidiUserInfoDialog })
</script>
  ...
  >
    ...
    >
      ...
      <el-form-item label="头像" prop="avatar">
        <CoverUpload
          :imageUrlPrefix="'/api/file/getAvatar/'"
